...
<head>
    <title>Editar usuario - YonkeMovil </title>
    ...
    <!--[if lt IE 9]>
      ...
      <link rel="stylesheet" type="text/css" href="app/frontend/css/base_datos/editar-usuario.css">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        ...
                                                        <span>Edita usuarios del sistema</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                     <h4>Puedes editar la siguiente información de los usuarios</h4>
                                                    </div>
