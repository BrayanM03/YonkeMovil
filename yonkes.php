...
<head>
    <title>Mis Yonkes - YonkeMovil </title>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <i class="icofont icofont icofont icofont-car-alt-4 bg-c-pink"></i>
                                                    <div class="d-inline">
                                                        <h4>Inventario de modelos</h4>
                                                        <span>Agrega modelos de los autos</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                       <button class="btn btn-round btn-info text-white" onclick="agregarModelo();"><i class="icofont icofont-ui-add"></i>Agregar modelo</button>
                                                        <span>Desde aqui agrega los modelos al sistema.</span>
                                                    ...
                                                    <div class="row">
                                                    <div class="col-lg-12">
                                                    <table width="100%" class="table table-bordered table-hover dt-responsive display nowrap" cellspacing="0" id="tabla-modelos"></table>
                                                    </div>
                                                    </div>
...
<script src="app/frontend/js/base_datos/modelos.js"></script>
<script>
var $window = $(window);
