  ...
  columns: [   
    ...
    { title: "Accion",
      ...
      render: function (row, data) {
        return '<div style="display: flex"><button onclick="editarUsuario(' +row.id+ ');" type="button" class="buttonPDF btn btn-success" style="margin-right: 8px"><span class="fa fa-edit"></span><span class="hidden-xs"></span></button><br>'+
...
function agregarUsuario() {
  ...
  '</form>',
     ...
     if(result.isConfirmed){
        ...
        if($("#buscador-yonke").attr("yonke") == null){
          ...
          sucursal = $("#buscador-yonke").attr("yonke");
          id_yonke = $("#buscador-yonke").attr("yonke_id");
        }
      ...
      $.ajax({
        ...
        data:{"nombre": nombre_usuario, "usuario": username, "contraseña": pass_usuario, "rol": rol_usuario, "puesto": puesto_usuario, "sucursal": sucursal, "yonke_id" : id_yonke},
        success: function(response) {
          if (response==1) {
            Swal.fire(
              "¡Correcto!",
  ...
  function asignarYonke(opcion){
    ...
    if($("#rol").val() == 0){
      ...
      '<select class="form-control" id="buscar-yonke"></select>');
