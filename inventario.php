...
<head>
    <title>YonkeMovil - Tus piezas al instante</title>
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="sample-page.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Sample</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        <h4>Inventario de piezas</h4>
                                                        <span>Busca, agrega o edita piezas de la refaccionaria</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                       <button class="btn btn-round btn-info"><i class="icofont icofont-ui-add"></i>Agregar pieza</button>
                                                        <span>Desde aqui agrega las piezas al sistema.</span>
                                                    ...
                                                    <div class="card-block">
                                                       <table class="table table-bordered table-striped" id="tabla-piezas"></table>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
