...
<head>
    <title>Mi inventario | YonkeMovil - Tus piezas al instante. </title>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="cjavasript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Autos</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="marcas.php">
                                                ...
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Marcas</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="modelos.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Modelos</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <i class="icofont icofont icofont icofont-tasks bg-c-pink"></i>
                                                    <div class="d-inline">
                                                        <h4>Mi inventario</h4>
                                                        <span>Agrega piezas o modelos de autos</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                       <button class="btn btn-round btn-info text-white" onclick="agregarModelo();"><i class="icofont icofont-ui-add"></i>Agregar nuevo</button>
                                                        <span>Desde aqui agrega tus piezas o autos al sistema.</span>
                                                    ...
                                                    <div class="row">
                                                    <div class="col-lg-12">
                                                    <table width="100%" class="table table-bordered table-hover dt-responsive display nowrap" cellspacing="0" id="tabla-piezas"></table>
                                                    </div>
                                                    </div>
...
<script src="app/frontend/js/inventario_yonkes/traer-inventario.js"></script>
<script>
var $window = $(window);
