...
session_start();
    ...
    if (isset($_POST["searchTerm"])) {
       ...
       $validar_comp = $con->prepare("SELECT COUNT(*) total FROM yonkes WHERE id LIKE ? OR nombre LIKE ? OR contacto LIKE ? OR numero LIKE ? OR direccion LIKE ? OR estatus LIKE ?");
       $validar_comp->bind_param('ssssss', $parametro, $parametro, $parametro, $parametro, $parametro, $estatus_activo);
